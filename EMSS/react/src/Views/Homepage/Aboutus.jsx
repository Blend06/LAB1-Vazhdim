            ...
            <div className="container">
                ...
                <div className="row align-items-center">
                    <div className="col-lg-6">
                        ...
                        <strong style={{color: '#178ca4'}}>AcademixPro</strong>  is a comprehensive school management system designed to streamline and enhance the 
                        ...
                        <p className={styles.aboutUsDescription}>
                        In addition to its core functionalities, <strong style={{color: '#178ca4'}}>AcademixPro</strong>  offers a range of customizable options to cater to
