    ...
    return (
        ...
        <main className={styles.main}>
            ...
            <div className="container text-center mb-4">
                <h1 className="section-title mb-0 mt-4">Get started with<strong style={{ fontWeight: 'bold', color: '#178ca4' }}> Academix Pro</strong></h1>
            </div>
                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-5 col-12">
                                <div style={{ marginTop: '70px' }}>
                                    <p className="content-text">Empowering educational institutions worldwide, <strong style={{ color: '#178ca4' }}>AcademixPro</strong> simplifies administrative tasks, enhances communication between stakeholders, and enriches the learning experience.</p>
                                    <p>With <strong style={{ color: '#178ca4' }}>Academix Pro</strong>, educators can focus more on teaching and less on paperwork, as the platform automates routine tasks such as attendance tracking, grade management, and communication with students and parents.</p>
                                </div>
                            </div>
                        </div>
                    </div>
