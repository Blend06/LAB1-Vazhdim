...
export default function DrejtoriForm() {
    const { id } = useParams();
    ...
    const onSubmit = (ev) => {
        ...
        if (user.id) {
            axiosClient.put(`/drejtori/${user.id}`, updateData)
                .then(() => {
                    navigate('/dashboard/drejtori');
                })
                .catch(err => {
                    console.error('An error occurred:', err);
                });
        } else {
            axiosClient.post(`/drejtori/`, updateData)
                .then(() => {
                    navigate('/dashboard/drejtori');
                })
                .catch(err => {
