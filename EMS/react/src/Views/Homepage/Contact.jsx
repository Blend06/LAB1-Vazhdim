                    ...
                    <div className="row gy-4">
                        <div className="col-lg-4" style={{ display: 'flex', alignItems: 'space-between', gap: '490px' }}>
                            <div className=" align-items-center info-item" data-aos="fade-up" data-aos-delay="300">
                                <i className="bi bi-geo-alt flex-shrink-0" style={{ color: '#ffffff', backgroundColor: '#178ca4', fontSize: '20px', width: '48px', height: '48px', display: 'flex', justifyContent: 'center', alignItems: 'center', borderRadius: '50px', transition: 'all 0.3s ease-in-out', marginRight: '15px' }}></i>
                                <div>
                            ...
                            <div className="align-items-center info-item" data-aos="fade-up" data-aos-delay="400">
                                <i className="bi bi-telephone flex-shrink-0" style={{ color: '#ffffff', backgroundColor: '#178ca4', fontSize: '20px', width: '48px', height: '48px', display: 'flex', justifyContent: 'center', alignItems: 'center', borderRadius: '50px', transition: 'all 0.3s ease-in-out', marginRight: '15px' }}></i>
                                <div>
                            ...
                            <div className=" align-items-center info-item" data-aos="fade-up" data-aos-delay="500">
                                <i className="bi bi-envelope flex-shrink-0" style={{ color: '#ffffff', backgroundColor: '#178ca4', fontSize: '20px', width: '48px', height: '48px', display: 'flex', justifyContent: 'center', alignItems: 'center', borderRadius: '50px', transition: 'all 0.3s ease-in-out', marginRight: '15px' }}></i>
                                <div>
